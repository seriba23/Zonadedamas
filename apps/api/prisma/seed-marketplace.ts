...
const BUSINESSES = [
  {
    ...
    businessType: 'SALON',
    description: 'Salon de belleza integral especializado en corte, color y tratamientos capilares. Ambiente sofisticado y atencion personalizada.',
    address: 'Av. Chapultepec 230, Col. Americana, Guadalajara',
    phone: '+52-33-1001-0001',
    location: { name: 'Sede Chapultepec', address: 'Av. Chapultepec 230, Col. Americana, Guadalajara', lat: 20.6736, lng: -103.3636 },
  ...
  },
  {
    ...
    description: 'Barberia urbana con estilo clasico americano. Cerveza artesanal cortesia mientras esperas. Solo para caballeros.',
    address: 'Av. Mexico 2500, Col. Ladron de Guevara, Guadalajara',
    phone: '+52-33-1002-0002',
    location: { name: 'BarberKings Ladron de Guevara', address: 'Av. Mexico 2500, Col. Ladron de Guevara, Guadalajara', lat: 20.6780, lng: -103.3710 },
  ...
  },
  {
    ...
    businessType: 'SPA',
    description: 'Centro de bienestar holistico. Masajes terapeuticos, circuito de aguas y tratamientos corporales en un entorno de paz.',
    address: 'Av. Patria 1501, Jardines Universidad, Zapopan',
    phone: '+52-33-1003-0003',
    location: { name: 'Zen Spa Patria', address: 'Av. Patria 1501, Jardines Universidad, Zapopan', lat: 20.7050, lng: -103.3900 },
  ...
  },
  {
    ...
    description: 'Clinica de medicina estetica y dermatologia avanzada. Tratamientos faciales con tecnologia de ultima generacion.',
    address: 'Av. Vallarta 3233, Col. Vallarta Poniente, Guadalajara',
    phone: '+52-33-1004-0004',
    location: { name: 'Clinica Vallarta', address: 'Av. Vallarta 3233, Col. Vallarta Poniente, Guadalajara', lat: 20.6760, lng: -103.3950 },
  ...
  },
  {
    ...
    businessType: 'SALON',
    description: 'El paraiso de las unas. Manicure, pedicure, nail art y extensiones. Mas de 500 colores disponibles.',
    address: 'Av. Lopez Mateos Sur 2375, Plaza del Sol, Guadalajara',
    phone: '+52-33-1005-0005',
    location: { name: 'Nails Factory Plaza del Sol', address: 'Av. Lopez Mateos Sur 2375, Plaza del Sol, Guadalajara', lat: 20.6520, lng: -103.4020 },
  ...
  },
  {
    ...
    businessType: 'BARBERIA',
    description: 'Barberia moderna con actitud rockera. Musica en vivo los viernes. Tu corte, tu estilo, sin excusas.',
    address: 'Calle Prisciliano Sanchez 440, Centro, Guadalajara',
    phone: '+52-33-1006-0006',
    location: { name: 'Corta y Calla Centro', address: 'Calle Prisciliano Sanchez 440, Centro, Guadalajara', lat: 20.6690, lng: -103.3490 },
  ...
  },
  {
    ...
    businessType: 'SALON',
    description: 'Estudio de maquillaje y cejas perfecto para novias, eventos y sesiones fotograficas. Productos de alta gama.',
    address: 'Av. Providencia 2642, Col. Providencia, Guadalajara',
    phone: '+52-33-1007-0007',
    location: { name: 'Glow Studio Providencia', address: 'Av. Providencia 2642, Col. Providencia, Guadalajara', lat: 20.6870, lng: -103.3830 },
  ...
  },
  {
    ...
    businessType: 'SPA',
    description: 'Autentico spa tailandes con terapeutas formadas en Chiang Mai. Masajes tradicionales y rituales orientales.',
    address: 'Av. Acueducto 4851, Puerta de Hierro, Zapopan',
    phone: '+52-33-1008-0008',
    location: { name: 'Thai Harmony Puerta de Hierro', address: 'Av. Acueducto 4851, Puerta de Hierro, Zapopan', lat: 20.7120, lng: -103.4180 },
  ...
  },
  {
    ...
    businessType: 'CLINICA',
    description: 'Centro integral de medicina estetica. Laser, depilacion definitiva, tratamientos corporales y faciales con resultados visibles.',
    address: 'Av. Americas 1536, Country Club, Guadalajara',
    phone: '+52-33-1009-0009',
    location: { name: 'Renovar Americas', address: 'Av. Americas 1536, Country Club, Guadalajara', lat: 20.6850, lng: -103.3750 },
  ...
  },
  {
    ...
    description: 'Estudio de tatuajes premium con artistas especializados en realismo, neotradicional, blackwork y acuarela. Ambiente esteril y profesional.',
    address: 'Calle Marsella 78, Col. Americana, Guadalajara',
    phone: '+52-33-1010-0010',
    location: { name: 'Ink Masters Americana', address: 'Calle Marsella 78, Col. Americana, Guadalajara', lat: 20.6710, lng: -103.3620 },
    admin: { email: 'admin@inkmasters.com', firstName: 'Diego', lastName: 'Navarro' },
    employees: [
      { firstName: 'Diego', lastName: 'Navarro', email: 'diego@inkmasters.com', color: '#212121', bio: 'Fundador y artista principal. 15 anos de experiencia en realismo y retratos' },
      { firstName: 'Luna', lastName: 'Vega', email: 'luna@inkmasters.com', color: '#7b1fa2', bio: 'Especialista en neotradicional, flores y mandalas' },
      { firstName: 'Raven', lastName: 'Cruz', email: 'raven@inkmasters.com', color: '#37474f', bio: 'Experto en blackwork, geometrico y dotwork' },
    ],
    services: [
      { name: 'Tatuaje Pequeno (hasta 5cm)', duration: 60, price: 80, color: '#212121', category: 'TATUAJES', subcategory: 'Tatuaje', points: 80 },
      { name: 'Tatuaje Mediano (5-15cm)', duration: 120, price: 180, color: '#424242', category: 'TATUAJES', subcategory: 'Tatuaje', points: 180 },
      { name: 'Tatuaje Grande (15-30cm)', duration: 240, price: 350, color: '#616161', category: 'TATUAJES', subcategory: 'Tatuaje', points: 350 },
      { name: 'Sesion Media Manga', duration: 300, price: 500, color: '#7b1fa2', category: 'TATUAJES', subcategory: 'Manga', points: 500 },
      { name: 'Retoque / Cover Up', duration: 90, price: 120, color: '#37474f', category: 'TATUAJES', subcategory: 'Retoque', points: 120 },
      { name: 'Consulta de Diseno', duration: 30, price: 0, color: '#9e9e9e', category: 'TATUAJES', subcategory: 'Consulta', points: 0 },
      { name: 'Piercing Basico', duration: 20, price: 35, color: '#ff5722', category: 'TATUAJES', subcategory: 'Piercing', points: 35 },
    ],
    hours: { open: '11:00', close: '21:00' },
  },
];
