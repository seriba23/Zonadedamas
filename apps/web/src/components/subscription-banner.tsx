...
export function SubscriptionBanner({ status, trialEndsAt }: SubscriptionBannerProps) {
  ...
  // ── CASO 2: requiere pago (PAST_DUE o SUSPENDED) ──
  // La cuenta queda limitada a la sección de suscripción hasta renovar. Sin plazo:
  // solo el mensaje de renovación. (Rojo, no ámbar, por la regla del proyecto.)
