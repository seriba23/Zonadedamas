...
export function SocialLoginButtons({ onSocialLogin, disabled }: SocialLoginButtonsProps) {
  ...
  return (
    <div className="space-y-3">
      ...
      {/* Botón "Continuar con Facebook" oculto temporalmente: Facebook Login
          aún no está implementado. Reactivar cuando se configure (handler
          handleFacebook y SDK ya están listos más arriba). */}
