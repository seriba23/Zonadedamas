              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    {/* Indicador de alergias: triángulo rojo con tooltip. El detalle
                        completo se ve al abrir la cita. */}
                    {(() => {
                      ...
                      return (
                        <svg
                          ...
                          aria-label={`Alergias del cliente: ${allergies}`}
                        >
                          <title>{`Alergias del cliente: ${allergies}`}</title>
