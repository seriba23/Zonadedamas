      ...
      {isLoading ? (
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-4 sm:p-6">
            {/* Header del card: titulo + URL arriba; botones debajo en
                mobile (flex-col), a la derecha en desktop (sm:flex-row).
                Asi se evita el scroll horizontal cuando la URL es larga. */}
            <div className="mb-4">
              <div className="mb-3">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <button
                  ...
                  className="flex-1 sm:flex-initial px-4 py-2 border border-gray-200 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-50 transition-colors flex items-center justify-center gap-2"
                >
                ...
                <button
                  onClick={handlePrint}
                  className="flex-1 sm:flex-initial px-4 py-2 bg-[#008080] text-white rounded-lg text-sm font-medium hover:bg-[#006666] transition-colors flex items-center justify-center gap-2"
                >
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
            ...
            {/* Scaled preview: contenedor con scroll vertical, sin overflow
                horizontal, escala al 50% para que entre en mobile. */}
            <div className="border border-gray-200 rounded-lg overflow-hidden bg-gray-50 p-2 sm:p-4">
              <div className="origin-top-left scale-[0.42] sm:scale-50" style={{ width: '240%' }}>
                <QrPrintTemplate
                  qrUrl={qr.url}
