...
const FEATURES: FeatureRow[] = [
  { label: 'Citas ilimitadas', basico: true, plus: true },
  { label: 'Clientes ilimitados', basico: true, plus: true },
  { label: 'Servicios y agenda', basico: true, plus: true },
  { label: 'Cupones y recompensas', basico: true, plus: true },
  { label: 'Inventario y proveedores', basico: true, plus: true },
  { label: 'Pagos y facturacion', basico: true, plus: true },
  { label: 'Personal y empleados', basico: false, plus: true },
            ...
            {FEATURES.map((f, i) => (
              ...
              >
                <div className="px-4 md:px-6 py-3 text-sm text-gray-800 flex items-center gap-2">
                  <span>{f.label}</span>
                  {f.highlight && (
                    <span className="text-[9px] font-bold px-1.5 py-0.5 rounded-full bg-[#008080] text-white">
                      DESTACADO
                    </span>
                  )}
                </div>
