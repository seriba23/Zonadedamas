...
function ReservationDetailModal({
  ...
  // El boton "Cobrar ahora" solo aparece cuando el apartado esta en
  // status cobrable y (no tiene cita asociada O la cita esta CANCELLED).
  // Apartados de citas activas se cobran al cobrar la cita.
  const isPayable =
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Acciones (Cobrar / Cancelar / Avanzar) — sticky abajo */}
        {(isPayable || (actions && (actions.cancel || actions.advance))) && (
          <div className="sticky bottom-0 px-5 py-3 bg-white border-t border-gray-100 flex flex-col gap-2">
            {isPayable && (
              <button
                type="button"
                onClick={() => {
