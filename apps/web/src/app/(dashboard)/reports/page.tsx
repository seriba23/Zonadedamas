  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto p-3 md:p-6">
        ...
        {/* Resumen financiero — ingresos combinados (servicios + productos) y ganancia neta */}
        <div className="mb-4 md:mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
            <KpiCard
              ...
              value={isLoading ? <span className="inline-block h-6 w-32 bg-[var(--border)] rounded animate-pulse" /> : formatCurrency(stats.kpis.totalRevenueAll)}
              subtitle={`Servicios ${formatCurrency(stats.kpis.totalRevenue)} · Productos ${formatCurrency(stats.kpis.productRevenue)}`}
            />
            <KpiCard
              icon={<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18L9 11.25l4.306 4.307a11.95 11.95 0 015.814-5.519l2.74-1.22m0 0l-5.94-2.28m5.94 2.28l-2.28 5.941" /></svg>}
