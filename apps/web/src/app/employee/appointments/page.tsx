...
function AppointmentRow({
  ...
  return (
    ...
    >
      ...
      {/* Alergias del cliente — alerta evidente en la tarjeta. */}
      {(() => {
        const allergies = (apt.client as any).allergies || (apt.client as any).user?.allergies;
        if (!allergies) return null;
        return (
          <div className="mt-3 flex items-start gap-1.5 text-xs bg-red-50 rounded-lg px-3 py-2 border border-red-200">
            <svg className="w-3.5 h-3.5 text-red-600 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" />
            </svg>
            <span className="text-red-800 leading-snug text-left">
